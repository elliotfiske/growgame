...
struct  GUILayoutEntry_t5_158  : public Object_t
{
	...
	GUIStyle_t5_20 * ___m_Style_7;
};
struct GUILayoutEntry_t5_158_StaticFields{
	// UnityEngine.Rect UnityEngine.GUILayoutEntry::kDummyRect
	Rect_t5_38  ___kDummyRect_8;
